        ...
        Area(name="Capital City",
            story_line=[
                ...
                },
                {
                    ...
                    "timeless gaze. Its cobbled paths, etched by countless "
                    "souls, converge at Yolkaris' beating heart."
                },
                {
                    "text": "Here stands the Grand Clock, silent sentinel of "
                    "time, now frozen in an eerie stillness. Amidst this "
                    "hush, Charlie, a beacon of hope, steps forward with "
                    "valor and inquisitiveness in his heart."
                },
                {
                    ...
                    "slumbering clock, a vestige of arcane power, a quest of "
                    "fate unfolds for Charlie."
                },
                {
                    "continue": True
                },
                {
                    ...
                    "fabric, he seeks to stir ancient echoes, awakening the "
                    "chronicles lost to the ages.",
                    "space": 1
                }
            ],
            story_line_visited=[
                ...
                },
                {
                    ...
                    "Grand Clock looms, casting a silent shadow over the "
                    "timeless streets.",
                    "space": 1
                }
            ],
            neutral=Neutral(
                ...
                story_line=[
                    ...
                    },
                    {
                        ...
                        "crystal and rekindle the clock's ancient magic.' ",
                    },
                    {
                    ...
                    },
                    {
                        ...
                        "'south', 'east', and 'west'. Discover your destiny."
                    },
                    {
        ...
        Area(name="Capital City",
            ...
            neutral=Neutral(
                ...
                story_line=[
                    ...
                    {
                        "text": "'Your journey will take you beyond the known, through the tapestry of stars, to worlds that have only existed in the whispers of the old. You must find the Aurora Orb and bring its light back to Yolkaris.' He paused, ensuring Charlie's full attention."
                    },
                    {
                        "continue": True
                    },
